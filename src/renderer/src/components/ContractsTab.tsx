...
import { getContracts, getRooms, getAppSettings, updateContract, type Contract, type ContractStatus } from '../lib/db'
...
export const ContractsTab: React.FC<ContractsTabProps> = ({ onAddNew }) => {
